...
1. **In the Virtual machines page, select `Create` and then `Virtual machine`. **
2. **In the `Basics` tab, under Instance details, Under Availability options, select `No infrastructure redundancy required`. Under Security type, select `Standard`. Choose `Ubuntu Server 22.04 LTS`. Choose `Size` as `B1s`.**

   <img width="1348" height="434" alt="image" src="https://github.com/user-attachments/assets/aedf1f4c-31a9-4e3c-b5d0-6074950a784d" />

3. **For SSH public key source, leave the default of Generate new key pair, and then enter myKey for the Key pair name.**

   <img width="1346" height="205" alt="image" src="https://github.com/user-attachments/assets/7817f727-7c31-4c7b-96f7-a5c80638ce8c" />

4. **On the `Disk` tab, select `OS Disk type` as `Standard_HDD`.**

   <img width="1348" height="291" alt="image" src="https://github.com/user-attachments/assets/9e1f78f0-1b57-4639-81d6-e2633ff60236" />

5. **On the Create a virtual machine page, review the details about the VM you're about to create. When you're ready, select Create.**

   <img width="1346" height="447" alt="image" src="https://github.com/user-attachments/assets/7c25efe3-1891-45b0-a03d-cc9146e77584" />


## Task 5: Virtual Machine Configuration and Log upload:
...
4. **Copy script to vm and update the python script with connection string.**
   ...
   `blob_conn_str = "<your_blob-container_connection_string>"`
...
7. **Run the script to send logs**

   ```sh
   python send_logs.py
   ```

## Task 6: Verify log generation and upload in container

1. **Check Event Hub receving logs**

   <img width="1087" height="429" alt="image" src="https://github.com/user-attachments/assets/a6914c8c-5131-41b0-8981-ef1687de46b8" />

   <img width="1097" height="424" alt="image" src="https://github.com/user-attachments/assets/49030c98-699f-493d-af6b-f4e3ed8ff21d" />

2. **Log file should also appear in Blob container**

   <img width="608" height="274" alt="image" src="https://github.com/user-attachments/assets/679b5aca-bf8c-4c0e-965b-57c7f5e679c3" />
